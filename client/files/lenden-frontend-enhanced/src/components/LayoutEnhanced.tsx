...
export const Layout: React.FC<LayoutProps> = ({ children, title }) => {
    ...
    const { user, logout, t, language, setLanguage, shopDetails } = useStore();
                ...
                <div className="flex-1 overflow-y-auto py-6 px-4 flex flex-col scrollbar-thin">
                    ...
                    <div className="mb-6">
                        ...
                        <nav className="space-y-1">
                            ...
                            <NavLink to="/staff" icon="badge" label={t('staff' as any) || 'Staff'} />
                            <NavLink to="/reports" icon="bar_chart" label={t('reports')} />
                        </nav>
                    </div>
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <div className="hidden sm:block">
                            <div className="flex items-center gap-2 mb-1">
                                ...
                                {shopDetails?.name && (
                                    <span className="px-2 py-0.5 bg-primary-100 dark:bg-primary-950/50 text-primary-700 dark:text-primary-300 text-[10px] font-bold rounded-full">
                                        {shopDetails.name}
                                    </span>
                                )}
                            </div>
                        ...
                        <h2 className="sm:hidden text-lg font-bold text-gray-900 dark:text-white tracking-tight truncate">{title}</h2>
                    </div>
